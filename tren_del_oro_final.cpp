/*===================================================================
  ...
  - Carga automatica de archivos (.tren)
  - Gestion de grafos (mapa de metro con 30 estaciones)
  - Sistema de corrupcion (policias infiltrados)
  - Distribucion aleatoria de oro
  - Sistema de turnos completo
  - CONDICIONES DE VICTORIA IMPLEMENTADAS (3 facciones)
  - BITACORA DEL JUEGO COMPLETA
  - TODAS LAS ACCIONES DEL JUEGO IMPLEMENTADAS
  - Validacion profesional de todos los campos
  
  ESTRUCTURA DE DATOS:
  - Listas simplemente enlazadas (personajes, implementos)
  - Grafo (lista de adyacencia) para conexiones del metro
  - Estructura de datos para oro, pistas y bitacora
  ...
  - Ejecucion: Requiere archivos .tren en directorio actual
===================================================================*/
